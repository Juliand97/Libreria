...
Class Login
{
	...
	{
		$consulta2="SELECT identificacion,p_nombre,contrasena,estado,roles.u_rol,roles.t_permiso FROM usuarios INNER JOIN roles INNER JOIN permisos WHERE identificacion='$id'and id_usuario=identificacion and u_rol=id_rol";
		#echo $consulta2;
		...
		#echo $t_permiso;
		if ($t_permiso=="admin" and $estado=1)
		{
		...
		if ($t_permiso=="cliente" and $estado=1)
		{
