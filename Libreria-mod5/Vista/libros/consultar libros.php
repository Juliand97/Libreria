	...
	<table >
	 <!--botones de existencias, registro y menú--> 
		...
		<form action="../cant/consulta_cant_ctrl.php">
			...
			<form action="../reportes/reportes_ctrl.php">
			<input type="submit" name="add" value="Reportes." class="boton2" >
		</form>	
