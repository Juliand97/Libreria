...
<?php
	...
	$ver=new editar();/*llamado de la clase*/
				...
				<p>Actualización de datos</p>
					<table width="190" border=1>
						...
						<tr>
							<td>
								<p>Editorial</p>
								<input type="text" name="edito" value="<?php echo $Editorial; ?>">
							</td>
						</tr>
						<tr>
							<td>
								<p>Categoria</p>
								<input type="text" name="cate" value="<?php echo $Categoria; ?>">
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							<td>
								<p>Disponibilidad</p>
								<input type="text" name="V8" value="<?php echo $Disponibilidad; ?>" >
							</td>
						</tr>
