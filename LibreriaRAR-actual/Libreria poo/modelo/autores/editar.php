...
{
		$ver= new editar();//llamado a la clase
...
{	//variables que recepcionaran los datos(variables globales)
	...
	public function modificar()
	{
		...
		$con=$inten->conm();
		//sentencia sql
		$actualizar= "UPDATE `autores` SET `no_registro`= '$this->reg',`nombrea`= '$this->name',`apellidoa`= '$this->lname',`nac`= '$this->nac', `fechan`= '$this->dateb',`estadoa`= '$this->state',`obras`= '$this->obras'  WHERE no_registro='$this->dato_e'";
