...
.text
{
	...
	<div id="particles-js">
		<div class="base">
			...
			<div class="cara1">
				<div class="lupa">
					<img src="../../Vista/img/busqueda visitante/lupa.png" class="imagen">
				</div>
				
			
			<figure class="cara2">
			<form action="busqueda_visitante_ctrl-r.php" method="post">
				<p class="text">Por favor diligencie los siguientes datos</p>
				<input type="text" placeholder="Nombre del libro" id="libro"  name="libro" autofocus required>
				<br><br>
