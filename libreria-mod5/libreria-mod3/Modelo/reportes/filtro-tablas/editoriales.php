...
class a_edit
{
	...
	public function arreglo($consulta)
	{
		...
		$objPHPExcel->setActiveSheetIndex(0)
					...
					->setCellValue('E1','jefe_editorial')
		...
		while ($informe=$consulta->fetch_array(MYSQLI_ASSOC))
		{
			$objPHPExcel->setActiveSheetIndex(0)
						...
						->setCellValue("C$i",$informe['ubicacion'])
						->setCellValue("D$i",$informe['telefono'])
						->setCellValue("E$i",$informe['jefe_editorial'])
						->setCellValue("F$i",$informe['fecha_creacion']);
