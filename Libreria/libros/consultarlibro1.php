<body background="imagenes/Libros.jpg" text="#FFFFFF">
<?php
...
//	}
	...
	';
		...
		echo "<td><form action='../menureg.html'>
<input type='submit' value='Volver a Registros y consultas'>
</form></td><td><form action='actualizarlibro.html'>
<input type='submit' value='Actualizar libro'>
</form></td><td><form action='borrarlibro.html'>
