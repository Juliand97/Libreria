...
if (isset($_POST ['insert']))
{
 ...
 class Editorial
 {
	 ...
	 { 
		...
		$enviar= "INSERT INTO editoriales (ubicacion,telefono,correo,pbx,jefe_editorial,fecha_creacion,nombre_e,codigo_postal,estado) VALUES ('$this->ubicacion','$this->telefono','$this->correo','$this->pbx','$this->jefe_editorial','$this->fecha_creacion','$this->nombre_e','$this->codigo_postal','$visible')";
