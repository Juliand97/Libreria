<?php
	...
	if (isset ($_GET['editar']))
		{
			$ver=new editar_editorial ();
			$ver_d=$ver->seleccion ();
		}
	
	class editar_editorial
	{
		public $dato_e;
...
class Actualizar
	{	
		...
		
		{
			...
			$inten=new Conexion ();
			$con=$inten->conm();
			$actualizar="UPDATE editoriales SET codigo_postal= '$this->ide',nombre_e= '$this->nom_e' , ubicacion= '$this->ubi',correo= '$this->email',telefono= '$this->tel', pbx= '$this->pbx',fecha_creacion= '$this->fecha_cre',jefe_editorial= '$this->jefe_edi',estado='$visible' WHERE codigo_postal='$this->dato_e'";
