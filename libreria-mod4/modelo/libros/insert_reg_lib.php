...
class Libro 
{
	...
	public function insertar()
	{
		...
		//setencias sql
		$enviar= "INSERT INTO `libros`(`isbn`, `libro`, `fecha`, `editorial`, `categoria`, `autor`, `pais_de_autor`,compra,estado)  VALUES ('$this->Isbn','$this->Libro','$this->Fecha','$this->Editorial','$this->Categoria','$this->Autor','$this->Pais_Autor','$estado_inicial','$visible')";
