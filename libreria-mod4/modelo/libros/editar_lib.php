...
//include ("controlador/base_de_datos.php"); 
	class Actualizar{
		...
		public function modificar()
		{
			...
			$visible=1;
			/*sentencia SQL*/
			$actualizar= "UPDATE libros SET isbn='$this->is', libro='$this->lib', fecha='$this->fec', editorial='$this->edi', categoria='$this->cate', autor='$this->aut', pais_de_autor='$this->pai_aut', compra='$this->disp', estado='$visible' WHERE isbn='$this->dato_e'";
