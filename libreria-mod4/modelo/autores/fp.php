...
if(isset($_POST['insert']))//si se le dio clic al boton enviar 
	{
		...
		header("Location: ../../Vista/autores/consulta.php");
...
class Autor 
{
	...
	public function insertar()
	{
		...
		{
		$enviar= "INSERT INTO `autores`(`no_registro`, `nombrea`, `apellidoa`,`nac`,`fechan`,`estadoa`,`obras`,estado)  VALUES ('$this->id','$this->nombre','$this->apellido','$this->nac','$this->fechan','$this->estado','$this->obras','$visible')";
