...
class Cliente 
{
	...
	public function insertar()
	{
		...
		{
		$enviar= "INSERT INTO `usuarios`(`identificacion`, `nombre`, `correo`, `contrasena`,estado)  VALUES ('$this->doc','$this->nombre','$this->correo',aes_encrypt('$credencial','$permiso'),'$visible')";
		echo $enviar;
