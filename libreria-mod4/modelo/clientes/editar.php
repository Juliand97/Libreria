...
if (isset($_GET['editar']))
{
	...
	class editar_cliente
	{
		...
		public function seleccion()
		{
			...
			/*$desencriptar="SELECT * from usuarios WHERE identificacion='$this->dato_e' and contrasena=aes_decrypt('contrasena','2018')";
			echo $desencriptar;
			$envio=mysqli_query($con,$desencriptar);
			$trae_c=mysqli_fetch_array($envio);
			$pass=$trae_c['contrasena'];
			echo $pass; */
...
<table width="190" border=6>
	...
	<input type = "email" name="email" value="<?php echo $correo; ?>"></td></tr>
	<tr><td><p>Contraseña</p><br>
	<input type = "password" name="contrasena" id="contrasena" value="<?php echo $contraseña; ?>" required autofocus></td></tr>

</table>
<table>
	<tr>
		<td>
		<p> confirmar contraseña<br> antes de actualizar</p>
...
{	//variables que recepcionaran los datos(variables globales)
	...
	public function modificar()
	{
		...
		//sentencia sql
$visible=1;
		$actualizar= "UPDATE `usuarios` SET `identificacion`= '$this->ide',`nombre`= '$this->nom',`correo`= '$this->co',contrasena=aes_encrypt('$this->cont','2018'), estado='$visible' WHERE identificacion='$this->dato_e'";
