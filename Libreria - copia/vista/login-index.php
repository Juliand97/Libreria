	...
	<body>
		<div class ="contenedor" align="center">
			...
			<form action="../controlador/login.php" method="post" id ="f1">
				<center>
				<p>Usuario</p>
				<input type="text" name="name" class="usuario" placeholder="ingrese su usuario " id="i1" >
				<p >contraseña</p>
				<input type="password" name="contraseña" class="contraseña" placeholder="ingrese su contraseña" id="i2" ><br><br>
