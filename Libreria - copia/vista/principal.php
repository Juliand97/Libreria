...
<html>
	...
	<ul>
			...
			<li><a href="#">Contactos<span class="fa fa-angle-down"></span></a><ul>
				...
				</ul><li> <p><?php echo $usuario; ?></p></li></li>
				<li><P> <form action="../controlador/cerrar sesion.php" method="post" class="logout"><input type="submit" value="Cerrar sesion"> </form></P></li></li>				</ul>
	</ul>
	</header>
	<body  bgcolor="#000000" text="#FFFFFF">
		...
		<table width="1000" border="0" cellpadding="0">
		  <tr>
			...
			<td><p><img name="" src="index/Imagenes/Cellular.png" width="82" height="66" alt="">: 3172543405- 3005631648</p></td>
